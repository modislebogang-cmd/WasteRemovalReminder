...
- **Admin Registration**: Admin-only staff registration with setup key
...
- Register new staff members (staff number, phone, store code)
- Create setup keys for staff registration
...
8. ✅ Role-based permissions (staff/manager/admin)
...
- Staff authentication uses Staff Number + Phone Number (stored in Firestore)
- Setup key required for admin to register new staff members
